    ...
    <script>
        $(function () {
            ...
            window.LaravelDataTables["dataTableBuilder"].on('draw', function () {
                ...
                let html = '<tr>';
                html += '<th style="text-align:right;width:80%;color:blue">รวมยอดถอนเงิน [Free] (ทั้งหมด)</th><th style="text-align:right;color:blue;">' + table.ajax.json().in_all + '</th>';
                html += '</tr>';
                html += '<tr>';
                html += '<th style="text-align:right;width:80%;color:blue">รวมยอดถอนเงิน [Free] (รออนุมัติ)</th><th style="text-align:right;color:blue;">' + table.ajax.json().in_wait + '</th>';
                html += '</tr>';
                html += '<tr>';
                html += '<th style="text-align:right;width:80%;color:blue">รวมยอดถอนเงิน [Free] (อนุมัติ)</th><th style="text-align:right;color:blue;">' + table.ajax.json().in_yes + '</th>';
                html += '</tr>';
                html += '<tr>';
                html += '<th style="text-align:right;width:80%;color:blue">รวมยอดถอนเงิน [Free] (ไม่อนุมัติ)</th><th style="text-align:right;color:blue;">' + table.ajax.json().in_no + '</th>';
                html += '</tr>';
