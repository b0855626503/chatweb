...
namespace Gametech\LogAdmin\Http\Controllers;

use Carbon\Carbon;

use Illuminate\Http\Request;
use Gametech\LogAdmin\Http\Traits\IpAddressDetails;
use Gametech\LogAdmin\Http\Traits\UserAgentDetails;
...
class LaravelLoggerController extends Controller
{
    ...
    public function clearActivityLog(Request $request)
    {
        ...
        return redirect('log-admin')->with('success', trans('LaravelLogger::laravel-logger.messages.logClearedSuccessfuly'));
    }
    ...
    public function destroyActivityLog(Request $request)
    {
        ...
        return redirect('log-admin')->with('success', trans('LaravelLogger::laravel-logger.messages.logDestroyedSuccessfuly'));
    }
    ...
    public function restoreClearedActivityLog(Request $request)
    {
        ...
        return redirect('log-admin')->with('success', trans('LaravelLogger::laravel-logger.messages.logRestoredSuccessfuly'));
    }
