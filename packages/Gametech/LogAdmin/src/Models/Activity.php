...
namespace  Gametech\LogAdmin\Models;

use DateTimeInterface;
use Gametech\Admin\Models\AdminProxy;
use Gametech\LogAdmin\Contracts\Activity as ActivityContract;
...
class Activity  extends Model implements ActivityContract
{
    ...
    {
        return $this->belongsTo(AdminProxy::modelClass(), 'userId');
    }
    ...
    {
        return \Gametech\LogAdmin\Http\Traits\UserAgentDetails::details($this->userAgent);
    }
}
