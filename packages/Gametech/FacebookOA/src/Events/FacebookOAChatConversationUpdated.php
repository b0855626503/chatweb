...
class FacebookOAChatConversationUpdated implements ShouldBroadcastNow
{
    ...
    public function __construct(FacebookConversation $conversation)
    {
        ...
        Log::channel('facebook_oa')->info('[FacebookOA] FacebookOAChatConversationUpdated::__construct', [
        ...
        $this->conversation = [
            ...
            'contact' => [
                ...
                'facebook_user_id' => $conversation->contact?->line_user_id,
    ...
    /**
     * ชื่อ event ฝั่ง JS → listen('.FacebookOAChatConversationUpdated')
     */
    public function broadcastAs(): string
    {
        return 'FacebookOAChatConversationUpdated';
    }
}
