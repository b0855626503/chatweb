...
if (!isset($btnSubmitText)) {
  $btnSubmitText = trans('LaravelLoggerUser::laravel-logger.modals.shared.btnConfirm');
}
@endphp
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        {!! Form::button('<i class="fa fa-fw fa-close" aria-hidden="true"></i> ' . trans('LaravelLoggerUser::laravel-logger.modals.shared.btnCancel'), array('class' => 'btn btn-outline pull-left btn-flat', 'type' => 'button', 'data-dismiss' => 'modal' )) !!}
