...
class FacebookOAConversationAssigned implements ShouldBroadcastNow
{
    ...
    public function __construct(FacebookConversation $conversation)
    {
        ...
        \Log::channel('facebook_oa')->info('[FacebookOA] FacebookOAConversationAssigned::__construct', [
    ...
    {
        return 'FacebookOAConversationAssigned';
    }
}
