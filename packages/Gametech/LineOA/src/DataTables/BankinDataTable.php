...
use Gametech\LineOA\Transformers\BankinTransformer;
...
class BankinDataTable extends DataTable
{
    ...
    public function dataTable($query): DataTableAbstract
    {
        ...
        return $dataTable->skipTotalRecords()->setTransformer(new BankinTransformer);
...
//            ->whereBetween('bank_payment.date_create', array($startdate, $enddate))
    ...
    public function html(): Builder
    {
        return $this->builder()
            ...
            ->minifiedAjax(route('admin.bank_in.index'))
            ->parameters([
                'dom' => 'Bfrtip',
                'processing' => true,
                'serverSide' => true,
