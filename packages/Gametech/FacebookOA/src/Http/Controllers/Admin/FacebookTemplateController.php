...
use Gametech\FacebookOA\DataTables\FacebookTemplateDataTable;
use Gametech\FacebookOA\Repositories\FacebookTemplateRepository;
use Gametech\Member\Repositories\MemberRepository;
use Illuminate\Http\Request;

class FacebookTemplateController extends AppBaseController
{
    protected $_config;
    ...
    public function index(FacebookTemplateDataTable $facebookTemplateDataTable)
    {
        return $facebookTemplateDataTable->render($this->_config['view']);
    }
