...
return [
    ...
    */
    ...
    'loggerDatabaseTable'       => env('LARAVEL_LOGGER_DATABASE_TABLE', 'logger_user_activity'),
    ...
    */
    ...
    'rolesMiddlware' => env('LARAVEL_LOGGER_ROLES_MIDDLWARE', 'loguser'),
    ...
    */
    ...
    'defaultActivityModel' => env('LARAVEL_LOGGER_ACTIVITY_MODEL', 'Gametech\LogUser\Models\ActivityUser'),
    'defaultUserModel'     => env('LARAVEL_LOGGER_USER_MODEL', 'Gametech\Member\Models\Member'),
    ...
    */
    ...
    'defaultUserIDField' => env('LARAVEL_LOGGER_USER_ID_FIELD', 'code'),
    ...
    */
    ...
    'loggerBladeExtended'       => env('LARAVEL_LOGGER_LAYOUT', 'admin::layouts.master'),
