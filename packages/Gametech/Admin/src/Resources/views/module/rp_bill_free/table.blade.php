    ...
    <script>
        $(function () {
            ...
            window.LaravelDataTables["dataTableBuilder"].on('draw', function () {
                ...
                html += '</tr>';
                html += '<tr>';
                html += '<th style="text-align:right;color:red">รวมยอดโยกออกเกม (ทั้งหมด)</th><th style="text-align:right;color:red;">' + table.ajax.json().out_all + '</th>';
                html += '</tr>';
                html += '<tr>';
                html += '<th style="text-align:right;color:red">รวมยอดโยกออกเกม (สำเร็จ)</th><th style="text-align:right;color:red;">' + table.ajax.json().out_yes + '</th>';
                html += '</tr>';
                html += '<tr>';
