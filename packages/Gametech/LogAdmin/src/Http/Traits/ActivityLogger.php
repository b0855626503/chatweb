...
namespace  Gametech\LogAdmin\Http\Traits;
...
trait ActivityLogger
{
     ...
     * @return void
     */
    public static function activitie($description = null, $details = null)
    {
        ...
        if (Auth::guard('admin')->check()) {
            ...
            $userId = Request::user('admin')->{$userIdField};
        }
     ...
     * @return void
     */
    private static function storeActivitie($data)
    {
     ...
     * @return string
     */
    private static function prepareErrorMessageNew($validatorErrors, $data)
    {
