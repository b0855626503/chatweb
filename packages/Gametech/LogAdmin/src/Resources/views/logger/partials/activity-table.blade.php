...
if (Request::is('log-admin/cleared')) {
    $prependUrl = '/log-admin/cleared/log/';
}

@endphp

<div class="dataTables_wrapper dt-bootstrap4 no-footer">
    <table class="table table-striped table-sm dataTable no-footer @if(config('LaravelLogger.enableDrillDown') && $hoverable) table-hover @endif data-table">
        <thead>
            <tr>
                <th>
