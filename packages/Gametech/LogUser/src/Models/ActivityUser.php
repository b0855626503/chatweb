...
use Gametech\LogUser\Contracts\ActivityUser as ActivityUserContract;
...
class ActivityUser  extends Model implements ActivityUserContract
{
    use SoftDeletes;
     ...
     * @var string
     */
    protected $table = 'logger_user_activity';
...
//     */
    ...
    {
        return $this->hasOne(MemberProxy::modelClass(),'code','userId');
    }

    public function member()
    {
        return $this->belongsTo(MemberProxy::modelClass(), 'userId');
    }
    ...
    public static function rules($merge = [])
    {
        if (app() instanceof Application) {
            $route_url_check = Application::VERSION < 5.8 ? 'active_url' : 'url';
        } else {
            $route_url_check = 'url';
        }
