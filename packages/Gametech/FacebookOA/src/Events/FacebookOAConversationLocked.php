...
class FacebookOAConversationLocked implements ShouldBroadcastNow
{
    ...
    public function __construct(FacebookConversation $conversation)
    {
        ...
        \Log::channel('facebook_oa')->info('[FacebookOA] FacebookOAConversationLocked::__construct', [
    ...
    {
        return 'FacebookOAConversationLocked';
    }
}
