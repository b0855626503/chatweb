    ...
    <script>
        $(function () {
            ...
            window.LaravelDataTables["dataTableBuilder"].on('draw', function () {
                ...
                let html = '<tr>';
                html += '<th style="text-align:right;width:80%;color:red">ยอดเงินออก (ทั้งหมด)</th><th style="text-align:right;color:red;">' + table.ajax.json().out_all + '</th>';
                html += '</tr>';
                // html += '<tr>';
                // html += '<th style="text-align:right;width:80%;color:blue">ยอดเงินออก (เติมสำเร็จ)</th><th style="text-align:right;color:blue;">'+table.ajax.json().out_yes+'</th>';
                // html += '</tr>';
                // html += '<tr>';
                // html += '<th style="text-align:right;width:80%;color:blue">ยอดเงินออก (รอเติม/พบปัญหา)</th><th style="text-align:right;color:blue;">'+table.ajax.json().out_no+'</th>';
                // html += '</tr>';
