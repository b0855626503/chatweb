...
class FacebookOAChatMessageReceived implements ShouldBroadcastNow
{
    ...
    public function __construct(FacebookConversation $conversation, FacebookMessage $message)
    {
        \Log::channel('facebook_oa')->info('[FacebookOA] FacebookOAChatMessageReceived::__construct', [
...
//        $conversation->loadMissing(['contact.member.bank', 'account']);
    ...
    {
        return 'FacebookOAChatMessageReceived';
    }
}
