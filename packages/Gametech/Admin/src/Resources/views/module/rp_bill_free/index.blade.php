                    ...
                    <form id="frmsearch" method="post" onsubmit="return false;">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    {!! Form::select('pro_code',  (['' => '== โปรโมชั่น ==']+$pros->toArray()), '',['id' => 'pro_code', 'class' => 'form-control form-control-sm']) !!}

                                </div>

                                <div class="form-group col-6">
                                    {!! Form::select('transfer_type', ['' => '== ประเภทการโยก ==' , '1' => 'โยกเข้า', '2' => 'โยกออก'], '',['id' => 'transfer_type', 'class' => 'form-control form-control-sm']) !!}

                                </div>

                                <div class="form-group col-6">
                                    {!! Form::select('enable', ['' => '== สถานะการโยก ==' , 'Y' => 'โยกสำเร็จ', 'N' => 'โยกไม่สำเร็จ'], '',['id' => 'enable', 'class' => 'form-control form-control-sm']) !!}
