            ...
            <div class="col-md-10 offset-md-1 col-sm-12">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <h5 class="text-color-fixed text-right">{{ is_null($profile->payments_promotion_credit_bonus_sum) ? '0.00' : $profile->payments_promotion_credit_bonus_sum }} ฿</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="card card-trans">
                            <div class="card-body">
                                ...
                                <input id="copy" class="form-control w-100" outsideclick="true" popover="คัดลอกสำเร็จ" type="text" value="{{ route('customer.session.store',$profile->code) }}">
                                <br>
                ...
                <div class="row text-light">
                    <div class="col-md-12">
                        <div class="card card-trans">
                            <div class="card-body">
                                <h4 class="content-heading">รายการเพื่อนที่แนะนำ</h4>
                                <div class="row">
                                    <div class="col">
        ...
        (() => {
            ...
            Vue.component('banks', {
                ...
                methods: {
                    ...
                    clicked: function () {
                        this.$http.post("{{ route('customer.contributor.store') }}", {'id':  'contributor' , 'date_start' : this.startdate  , 'date_stop' : this.enddate  })
                            .then(response => {
                                if (response.status) {
                                    this.list = response.data.data
                                }
