    ...
    <script>
        $(function () {
            ...
            window.LaravelDataTables["dataTableBuilder"].on('draw', function () {
                ...
                let html = '<tr>';
                html += '<th style="text-align:right;width:80%;color:blue">รวมยอดฝาก (Downline)</th><th style="text-align:right;color:blue;">' + table.ajax.json().deposit + '</th>';
                html += '</tr>';
                html += '<tr>';
                html += '<th style="text-align:right;width:80%;color:blue">รวมยอดโบนัส (Upline)</th><th style="text-align:right;color:blue;">' + table.ajax.json().bonus + '</th>';
                html += '</tr>';
