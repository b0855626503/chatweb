    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 offset-md-2 col-sm-12">
                ...
                <div class="row">
                    <div class="col-6">
                        <a class="btn btn-trans btn-block text-white" href="{{ route('customer.transfer.game.index') }}">โยกเข้าเกมส์ <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div class="col-6">
                                    ...
                                    <form method="POST" action="{{ route('customer.transfer.wallet.check') }}"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <p class="text-center text-warning">
                                                โยกเงินออกเกมส์ขั้นต่ำ {{ core()->currency($config->mintransferback) }} บาท</p>
