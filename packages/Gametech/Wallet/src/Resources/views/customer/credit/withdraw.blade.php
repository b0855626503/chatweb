                    ...
                    <div class="col-6">
                        <div class="card text-light card-trans">
                            <div class="card-body p-2">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h5 class="content-heading text-center"><i class="fal fa-wallet"></i> กระเป๋าแคชแบ๊ก</h5>
                    ...
                    <div class="col-6">
                        <div class="card text-light card-trans">
                            <div class="card-body p-2">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h5 class="content-heading text-center"><i class="fal fa-minus-octagon"></i> ถอนแล้ว</h5>
                                ...
                                <div class="justify-content-center" id="withdraw">
                                        <div class="row">
                                            <div class="col-6 offset-3">
                                                <img alt="" class="d-block mx-auto rounded-circle img-fix-size ng-star-inserted" style="width:80px" src="https://wallet.dumbovip.com/images/bank/{{ $profile->bank->filepic }}">
                                        ...
                                        <hr>
                                    <form method="POST" action="{{ route('customer.credit.store') }}" @submit.prevent="onSubmit">
                                        @csrf
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group mb-3">
                                                    <input v-validate="'required|numeric'"
                                                           class="form-control" :class="[errors.has('amount') ? 'is-invalid' : '']"
