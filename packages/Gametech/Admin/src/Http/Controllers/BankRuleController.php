...
use Gametech\Admin\DataTables\BankRuleDataTable;
use Gametech\Payment\Repositories\BankRuleRepository;
use Illuminate\Http\Request;


class BankRuleController extends AppBaseController
{
    protected $_config;
    ...
    public function index(BankRuleDataTable $bankRuleDataTable)
    {
        return $bankRuleDataTable->render($this->_config['view']);
    }
