...
return [
    ...
    */
    ...
    'loggerDatabaseTable'       => env('LARAVEL_LOGGER_DATABASE_TABLE', 'logger_admin_activity'),
    ...
    */
    ...
    'rolesMiddlware' => env('LARAVEL_LOGGER_ROLES_MIDDLWARE', 'logadmin'),
    ...
    */
    ...
    'defaultActivityModel' => env('LARAVEL_LOGGER_ACTIVITY_MODEL', 'Gametech\LogAdmin\Models\Activity'),
    'defaultUserModel'     => env('LARAVEL_LOGGER_USER_MODEL', 'Gametech\Admin\Models\Admin'),
