                    ...
                    <div class="col-6">
                        <div class="card text-light card-trans">
                            <div class="card-body p-2">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h5 class="content-heading text-center"><i class="fal fa-wallet"></i> กระเป๋าเงิน</h5>
                    ...
                    <div class="col-6">
                        <div class="card text-light card-trans">
                            <div class="card-body p-2">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h5 class="content-heading text-center"><i class="fal fa-minus-octagon"></i> ถอนวันนี้</h5>
                                ...
                                <div class="justify-content-center" id="withdraw">
                                    ...
                                    <form method="POST" action="{{ route('customer.withdraw.store') }}" @submit.prevent="onSubmit">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <p class="text-center text-warning">ยอดถอนขั้นต่ำ {{ $config->minwithdraw }} บาท</p>
