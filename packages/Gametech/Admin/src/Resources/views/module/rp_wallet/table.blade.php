    ...
    <script>
        $(function () {
            ...
            window.LaravelDataTables["dataTableBuilder"].on('draw', function () {
                ...
                let html = '<tr>';
                html += '<th style="text-align:right;width:80%">รวมยอด <span class="badge badge-success">เพิ่ม Wallet</span></th><th style="text-align:right;color:blue;">' + table.ajax.json().deposit + '</th>';
                html += '</tr>';
                html += '<tr>';
                html += '<th style="text-align:right;">รวมยอด <span class="badge badge-danger">ลด Wallet</span></th><th style="text-align:right;color:red;">' + table.ajax.json().withdraw + '</th>';
                html += '</tr>';
